...
Last.fm [command aliases: lastfm, lfm, lf] / Music Stuff:
	...
	18. Check how many plays you have for a track             : *lastfm [playstrack|playst] <track> [NOTE: specify artist for best guess]
...
Information / Search:
	...
	36. Sends a .wav file of text speech                      : *[texttospeech|tts] <text>
		1. Sends a .wav file of text speech w/ custom lang    : *texttospeech|tts] [custom|c] <text>
